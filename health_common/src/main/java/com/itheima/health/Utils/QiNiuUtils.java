...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "e7PMG63yttRh0FxrWCA6PGnWenoju8Eydrh_zwvr";
    private static final String SECRETKEY = "6AlffjaMQgS2N_J23LAe2g2bm4RRjOEbsGODHo7P";
    private static final String BUCKET = "arcticfish123";
    public static final String DOMAIN= "http://qiqhp8ed4.hn-bkt.clouddn.com/";
